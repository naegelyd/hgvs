#######################################################################
# XXX: This is only included here until the Python 3 version is released. There
# is a PR open at:
#
#       https://bitbucket.org/ericvsmith/recordtype/pull-requests/1/add-python-3-support/diff
#
#
